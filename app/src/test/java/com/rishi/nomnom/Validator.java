...
public class Validator {
    ...
    private static void verifyFirstPhoto(Photo photo) {
        Assert.assertEquals(photo.getPhotoRef(),
                "CmRaAAAAi8thfGP1CT0-RTWLN-BdOQi91lvoL7cnbwk2PftcnbJLkgHnuayXCs9ddQ-GO69tpWfKlefA8icPJkaoyO1VcIEFddWthBMwHrB_18zp3xVgCe3Qn_bnHK2YoYELSnzkEhBahVYWzXrMSHfyorx1lVJqGhQAHSbKHN_rPotmh0qXeaRsTWd8mA");
        Assert.assertEquals(photo.getPhotoUrl(),
                "https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&key=AIzaSyB-bpw0ollWA5AKpT11Y2CL2qPFs4kC_dk&photo_reference=CmRaAAAAi8thfGP1CT0-RTWLN-BdOQi91lvoL7cnbwk2PftcnbJLkgHnuayXCs9ddQ-GO69tpWfKlefA8icPJkaoyO1VcIEFddWthBMwHrB_18zp3xVgCe3Qn_bnHK2YoYELSnzkEhBahVYWzXrMSHfyorx1lVJqGhQAHSbKHN_rPotmh0qXeaRsTWd8mA");
    }
    ...
    private static void verifySecondPhoto(Photo photo) {
        Assert.assertEquals(photo.getPhotoRef(),
                "CmRaAAAATQzRV8lCYaAfDjRtxvSfELCwdVJO13p-3W6msTK5YVoJ8Wdea1KL_17h2t0zOkx2Wnm73gbxPv5t8TKQSmAxXcBE_XQkfaoQBW898o7C0VAu8gHVRyo1zcvaYjmaLPQqEhDsM1tnqo62iVL-M2Hq_NeRGhRM2HSoRNrN0DkqKlrCvZXMLtIrvA");
        Assert.assertEquals(photo.getPhotoUrl(),
                "https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&key=AIzaSyB-bpw0ollWA5AKpT11Y2CL2qPFs4kC_dk&photo_reference=CmRaAAAATQzRV8lCYaAfDjRtxvSfELCwdVJO13p-3W6msTK5YVoJ8Wdea1KL_17h2t0zOkx2Wnm73gbxPv5t8TKQSmAxXcBE_XQkfaoQBW898o7C0VAu8gHVRyo1zcvaYjmaLPQqEhDsM1tnqo62iVL-M2Hq_NeRGhRM2HSoRNrN0DkqKlrCvZXMLtIrvA");
    }

    public static void verifyDetailOpenHours(OpenHours openHours) {
    ...
    public static void verifyDetailPhoto(Photo photo) {
        Assert.assertEquals(photo.getPhotoRef(),
                "CmRaAAAAQGEmXBJ8vBC4P9tJlpl-zwd7TzALRS7iUlGKWXQ-EKti2aWVC_XNd3kZ7fyqlKcb7qIcsMnJXZ85pXfTljjqVSCBLLZILvkDdEPr1voNcYK1w-C1OX1gHYsUZm_q5CL4EhCBn61UyTQN3-n3FuUZXEJRGhS7a9QQseZz9TVPfKaeURz9CgQsug");
        Assert.assertEquals(photo.getPhotoUrl(),
                "https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&key=AIzaSyB-bpw0ollWA5AKpT11Y2CL2qPFs4kC_dk&photo_reference=CmRaAAAAQGEmXBJ8vBC4P9tJlpl-zwd7TzALRS7iUlGKWXQ-EKti2aWVC_XNd3kZ7fyqlKcb7qIcsMnJXZ85pXfTljjqVSCBLLZILvkDdEPr1voNcYK1w-C1OX1gHYsUZm_q5CL4EhCBn61UyTQN3-n3FuUZXEJRGhS7a9QQseZz9TVPfKaeURz9CgQsug");
    }

    public static void verifyFirstReview(Review review) {
        Assert.assertEquals(review.getAuthorName(), "Michelle Vu");
        Assert.assertEquals(review.getTimeStamp(), 1505853918);
        Assert.assertEquals(review.getProfilePhotoUrl(),
                "https://lh3.googleusercontent.com/-XbHClCJDyGI/AAAAAAAAAAI/AAAAAAAAJUc/g5mlEzGJkJY/s128-c0x00000000-cc-rp-mo-ba3/photo.jpg");
    }
}
